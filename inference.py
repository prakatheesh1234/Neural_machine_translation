...
class Paraphraser(object):
    ...
    def __init__(self, checkpoint):
        ...
        saver.restore(self.sess, "D:\\neural_machine_translation\\paraphraser\\train-20180325-001253\\model-171856")

    def sample_paraphrase(self, sentence, sampling_temp=1.0, how_many=2):
...
def main():
    ...
    paraphraser = Paraphraser("D:\\neural_machine_translation\\paraphraser\\train-20180325-001253\\model-171856")

    while 1:
        source_sentence = input("Source: ")
        #p = paraphraser.greedy_paraphrase(source_sentence)
        #print(p)
        paraphrases = paraphraser.sample_paraphrase(source_sentence, sampling_temp=0.50, how_many=10)
